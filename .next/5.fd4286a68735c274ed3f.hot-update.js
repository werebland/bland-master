...
})(["width:72px;height:72px;position:fixed;right:72px;display:flex;align-items:center;justify-content:center;@media all and (max-width:860px){right:24px;}@media all and (max-width:520px){right:12px;}"]);
...
//# sourceMappingURL=5.fd4286a68735c274ed3f.hot-update.js.map