...
})(["width:100vw;height:100vh;display:flex;flex-flow:row nowrap;align-items:center;justify-content:flex-end;padding:72px;box-sizing:border-box;position:relative;@media all and (max-width:860px){padding:72px 48px;}@media all and (max-width:770px){flex-flow:column nowrap;align-items:flex-start;justify-content:flex-start;}@media all and (max-width:520px){padding:72px 24px;}"]);
...
//# sourceMappingURL=5.580b36fa67f1116d4127.hot-update.js.map