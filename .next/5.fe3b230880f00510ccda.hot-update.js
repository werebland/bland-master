...
})(["width:100%;height:64px;display:flex;align-items:center;justify-content:center;color:#fff;font-size:1.5rem;font-weight:400;position:relative;z-index:1;cursor:pointer;text-decoration:none;border:2px solid #fff;& i{transition:0.2s ease-out all;transform:translateX(0);font-size:1.5rem;}&:hover i{transform:translateX(4px);}"]);
...
//# sourceMappingURL=5.fe3b230880f00510ccda.hot-update.js.map