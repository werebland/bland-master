...
})(["width:calc(100vw - 144px);height:calc(100vh - 144px);position:absolute;background:#0f0f0f;top:72px;right:72px;left:72px;bottom:72px;padding:48px 408px 48px 48px;"]);
var SectionCard = __WEBPACK_IMPORTED_MODULE_1_styled_components__["b" /* default */].div.withConfig({
  displayName: "Services__SectionCard",
  componentId: "sc-1v7dk2-2"
})(["width:360px;height:100%;background:#fff;box-shadow:0 2px 16px -2px rgba(159,159,159,0.32);"]);
...
//# sourceMappingURL=5.61dd47d30b457c9e4ed3.hot-update.js.map