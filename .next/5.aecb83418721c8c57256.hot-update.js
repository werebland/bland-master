...
})(["width:72px;height:72px;position:fixed;right:72px;display:flex;align-items:center;justify-content:center;@media all and (max-width:860px){right:24px;}@media all and (max-width:520px){right:0;}"]);
...
//# sourceMappingURL=5.aecb83418721c8c57256.hot-update.js.map