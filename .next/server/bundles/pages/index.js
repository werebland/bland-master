...
var HeaderWrapper = external__styled_components__default.a.div.withConfig({
...
var HeaderLogo = external__styled_components__default.a.div.withConfig({
...
var HeaderContact = external__styled_components__default.a.a.withConfig({
...
var MenuToggle = external__styled_components__default.a.div.withConfig({
...
var MenuToggleIcon = external__styled_components__default.a.div.withConfig({
...
var Header_Header = function Header(_ref) {
  ...
  return external__react__default.a.createElement(HeaderWrapper, {
    className: "header"
  }, external__react__default.a.createElement(HeaderLogo, {
    className: "header__logo"
  }), external__react__default.a.createElement(HeaderContact, {
    href: "",
    className: "header__contact"
  }, "Contact"), external__react__default.a.createElement(MenuToggle, null, external__react__default.a.createElement(MenuToggleIcon, {
    open: open,
    onClick: function onClick() {
      return handleMenuToggle();
    }
  }, external__react__default.a.createElement("span", null), external__react__default.a.createElement("span", null))));
};
...
var external__react_pose_ = __webpack_require__(2);
var external__react_pose__default = /*#__PURE__*/__webpack_require__.n(external__react_pose_);

// CONCATENATED MODULE: ./components/Menu.jsx



var MenuWrapper = external__react_pose__default.a.div({
  visible: {
    y: '0vh'
  },
  hidden: {
...
var StyledMenuWrapper = external__styled_components__default()(MenuWrapper).withConfig({
...
var Menu_Menu = function Menu(_ref) {
  var open = _ref.open;
  return external__react__default.a.createElement(StyledMenuWrapper, {
    className: "menu",
...
var external__floating_label_react_ = __webpack_require__(8);
...
var Services_Section = external__styled_components__default.a.section.withConfig({
...
var Services_SectionContent = external__styled_components__default.a.div.withConfig({
...
var Services_SectionCard = external__styled_components__default.a.article.withConfig({
...
var Services_SectionTitle = external__styled_components__default.a.h3.withConfig({
  displayName: "Services__SectionTitle",
  componentId: "sc-1v7dk2-3"
})(["font-size:2rem;font-weight:500;color:#0f0f0f;margin:0 0 24px 0;"]);
var ServicesItems = external__styled_components__default.a.ul.withConfig({
...
var ServicesItem = external__styled_components__default.a.li.withConfig({
...
var ServicesChanger = external__react_pose__default.a.div({
  visible: {
    opacity: 1,
    y: 0
  },
...
var StyledServicesChanger = external__styled_components__default()(ServicesChanger).withConfig({
...
var ServicesTitle = external__styled_components__default.a.h4.withConfig({
  displayName: "Services__ServicesTitle",
  componentId: "sc-1v7dk2-7"
})(["font-size:2rem;font-weight:500;color:#fff;margin:0 0 24px 0;"]);
var ServicesCopy = external__styled_components__default.a.p.withConfig({
...
/*#__PURE__*/
function (_Component) {
  Services__inherits(Services, _Component);

  function Services(props) {
    var _this;

    Services__classCallCheck(this, Services);

    _this = Services__possibleConstructorReturn(this, (Services.__proto__ || Object.getPrototypeOf(Services)).call(this, props));
    _this.state = {
      service: 'branding'
    };
    return _this;
  ...
  Services__createClass(Services, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      return external__react__default.a.createElement(Services_Section, {
        className: "services"
      }, external__react__default.a.createElement(Services_SectionContent, {
        className: "services__content"
      }, external__react__default.a.createElement(StyledServicesChanger, {
        pose: this.state.service === "branding" ? 'visible' : 'hidden'
      }, external__react__default.a.createElement(ServicesTitle, {
        className: "services__title"
      }, "Branding & Identity"), external__react__default.a.createElement(ServicesCopy, {
        className: "services__copy"
      }, "Your brand is who you are and it\u2019s more than just details. It is your personality, the who, what, where, and why. We work with you to create something that we both can be proud of. A brand that wears its identity on its sleeve. Thoughtful and precise, while still being everything you could hope it could be and more.", external__react__default.a.createElement("br", null), external__react__default.a.createElement("br", null), "From ideation and logo work, to creating style guides and ensuring brand fidelity, we\u2019re here to make everything go right.")), external__react__default.a.createElement(StyledServicesChanger, {
        pose: this.state.service === "content" ? 'visible' : 'hidden'
      }, external__react__default.a.createElement(ServicesTitle, {
        className: "services__title"
      }, "Content"), external__react__default.a.createElement(ServicesCopy, {
        className: "services__copy"
      }, "Your brand is who you are and it\u2019s more than just details. It is your personality, the who, what, where, and why. We work with you to create something that we both can be proud of. A brand that wears its identity on its sleeve. Thoughtful and precise, while still being everything you could hope it could be and more.", external__react__default.a.createElement("br", null), external__react__default.a.createElement("br", null), "From ideation and logo work, to creating style guides and ensuring brand fidelity, we\u2019re here to make everything go right."))), external__react__default.a.createElement(Services_SectionCard, {
        className: "services__card"
      }, external__react__default.a.createElement(Services_SectionTitle, null, "Services"), external__react__default.a.createElement(ServicesItems, {
        className: "services__items"
      }, external__react__default.a.createElement(ServicesItem, {
      ...
      }, "Branding & Identity"), external__react__default.a.createElement(ServicesItem, {
        className: "services__items--item",
      ...
      }, "Content Creation"), external__react__default.a.createElement(ServicesItem, {
        className: "services__items--item",
      ...
      }, "Social Media Management"), external__react__default.a.createElement(ServicesItem, {
        className: "services__items--item",
      ...
      }, "Customer Retention"), external__react__default.a.createElement(ServicesItem, {
        className: "services__items--item",
      ...
      }, "Reputation Management"), external__react__default.a.createElement(ServicesItem, {
        className: "services__items--item",
...
function (_Component) {
  ...
  pages__createClass(Index, [{
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement(PageWrapper, null, external__react__default.a.createElement(components_Menu, {
      ...
      }, "See what we can do")), external__react__default.a.createElement(components_Why, null), external__react__default.a.createElement(components_Services, null));
    }
  }]);
