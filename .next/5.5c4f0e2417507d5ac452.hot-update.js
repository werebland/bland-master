...
})(["width:100vw;height:72px;position:absolute;top:0;right:0;left:0;display:flex;align-items:center;justify-content:space-between;padding:0 144px 0 72px;box-sizing:border-box;z-index:", ";;@media all and (max-width:860px){padding:0 96px 0 24px;}"], function (props) {
  return props.open && '8';
});
...
//# sourceMappingURL=5.5c4f0e2417507d5ac452.hot-update.js.map